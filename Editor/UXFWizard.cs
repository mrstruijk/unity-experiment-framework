...
namespace UXF.EditorUtils
{
    ...
    public class UXFWizard : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            if (GUILayout.Button("Select Windows / PC VR"))
                SetSettingsWindows();
            if (GUILayout.Button("Select Web Browser"))
                SetSettingsWebGL();
            if (GUILayout.Button("Select Android VR (e.g. Oculus Quest)"))
                SetSettingsOculus();
            if (GUILayout.Button("Select Android"))
                SetSettingsAndroid();
